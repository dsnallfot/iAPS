            ...
            VStack {
                ...
                HStack {
                    InstructionList(instructions: [
                        ...
                        LocalizedString("Remove the Pods blue needle cap and check cannula. Then remove paper backing.", comment: "Label text for step two of attach pod instructions"),
