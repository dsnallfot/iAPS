    ...
    private func statistics() {
        ...
        if settingsManager.settings.uploadStats {
            ...
            insulin = Ins(
                ...
                temp_basal: insulinDistribution
                    .first != nil ? ((insulinDistribution.first?.tempBasal ?? 0) as Decimal) : 0,
            ...
            let hbA1cUnit = !overrideHbA1cUnit ? (units == .mmolL ? "mmol/mol" : "%") :
                (units == .mmolL ? "%" : "mmol/mol")
